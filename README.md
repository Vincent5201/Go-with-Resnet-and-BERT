...
## Overview
This project was originally developed as my undergraduate capstone project (see the [BERT-for-GO-prediction](https://github.com/Vincent5201/BERT-for-GO-prediction)).
...
After the undergraduate capstone project was completed, I continued expanding the project (detailed in next paragraph). This project serves both as a learning experience and as a playable Go engine that allows direct matches against trained models.
